...
\midrule
(Intercepto) & 256.224 & 159.955 & 1.602 & 0.109 \\
RAM (GB) & 81.097 & 2.581 & 31.418 & \textless{}2e-16 *** \\
CPU (GHz) & 212.524 & 24.319 & 8.739 & \textless{}2e-16 *** \\
Pulgadas & -20.165 & 11.075 & -1.821 & 0.069 . \\
\bottomrule
\end{tabular}
\\[0.3cm]
\small Significancia: *** p\textless{}0.001, ** p\textless{}0.01, * p\textless{}0.05, . p\textless{}0.1
\end{table}
...
\textbf{Variable} & \textbf{Coeficiente} & \textbf{Error Est.} & \textbf{t} & \textbf{p-valor} \\
\midrule
TypeNameGaming & -48.918 & 53.601 & -0.913 & 0.362 \\
TypeNameNetbook & -233.976 & 88.046 & -2.657 & 0.008 ** \\
TypeNameNotebook & -289.965 & 42.820 & -6.772 & \textless{}2e-16 *** \\
TypeNameUltrabook & 133.461 & 45.441 & 2.937 & 0.003 ** \\
TypeNameWorkstation & 649.459 & 85.047 & 7.636 & \textless{}2e-16 *** \\
\midrule
OpSysConsolidadoLinux & -39.843 & 94.076 & -0.424 & 0.672 \\
OpSysConsolidadoNo OS & -91.840 & 93.216 & -0.985 & 0.325 \\
OpSysConsolidadoOtros & 220.355 & 105.629 & 2.086 & 0.037 * \\
OpSysConsolidadoWindows 10 & 150.111 & 80.268 & 1.870 & 0.062 . \\
OpSysConsolidadoWindows 7 & 556.216 & 98.622 & 5.640 & \textless{}2e-16 *** \\
\bottomrule
\end{tabular}
\\[0.3cm]
\small Las categorías de referencia son: TypeName = ``2 in 1 Convertible'', OpSysConsolidado = ``Chrome OS''
\end{table}
...
Error estándar residual & 381.4 \\
Grados de libertad (modelo) & 13 \\
Grados de libertad (residuos) & 1,289 \\
\bottomrule
\end{tabular}
\end{table}

El resultado del modelo es satisfactorio, pues explica el 70.5\% de la variabilidad del precio de una laptop, y los valores de nuestro estadístico F y P-Valor nos indican que nuestro modelo tiene una validez estadística del análisis con un error estándar de estimación de 381.4 EUR.

\subsection{Modelo}
El modelo planteado quedaría de la siguiente manera:
\begin{equation}
\begin{aligned}
\widehat{\text{Precio}}_i = & \ 256.224 + 81.097 \cdot \text{RAM}_i + 212.524 \cdot \text{CPU}_i - 20.165 \cdot \text{Pulgadas}_i \\
& - 48.918 \cdot \text{Gaming}_i - 233.976 \cdot \text{Netbook}_i - 289.965 \cdot \text{Notebook}_i \\
& + 133.461 \cdot \text{Ultrabook}_i + 649.459 \cdot \text{Workstation}_i \\
& - 39.843 \cdot \text{Linux}_i - 91.840 \cdot \text{No OS}_i + 220.355 \cdot \text{Otros}_i \\
& + 150.111 \cdot \text{Windows 10}_i + 556.216 \cdot \text{Windows 7}_i
\end{aligned}
\end{equation}
...
\begin{itemize}
    \item \textbf{RAM (GB):} Por cada aumento de 1 GB en la memoria RAM, el precio de la laptop aumenta en promedio 81.10 EUR, manteniendo constantes las demás variables.
    
    \item \textbf{CPU (GHz):} Por cada aumento de 1 GHz en la frecuencia del procesador, el precio aumenta en promedio 212.52 EUR. Esto indica que el procesador es uno de los componentes más determinantes del precio.
    ...
    \item \textbf{Tipo de Laptop:} Las Workstation tienen un precio promedio 649.46 EUR mayor que las ``2 in 1 Convertible'' (categoría de referencia), mientras que los Notebook son 289.97 EUR más baratos. Los Netbook son 233.98 EUR más baratos.
    
    \item \textbf{Sistema Operativo:} Windows 7 tiene un precio promedio 556.22 EUR mayor que Chrome OS (categoría de referencia). La categoría ``Otros'' (que agrupa Android, Mac OS X, macOS y Windows 10 S) es 220.36 EUR más cara.
\end{itemize}
    ...
    \midrule
    (Intercept) & -57.576 & 570.024 \\
    Ram\_GB & 76.034 & 86.161 \\
    CPU\_GHz & 164.815 & 260.233 \\
    Inches & -41.892 & 1.562 \\
    \midrule
    TypeNameGaming & -154.073 & 56.237 \\
    TypeNameNetbook & -406.705 & -61.247 \\
    TypeNameNotebook & -373.969 & -205.961 \\
    TypeNameUltrabook & 44.315 & 222.607 \\
    TypeNameWorkstation & 482.613 & 816.305 \\
    \midrule
    OpSysConsolidadoLinux & -224.401 & 144.716 \\
    OpSysConsolidadoNo OS & -274.711 & 91.031 \\
    OpSysConsolidadoOtros & 13.131 & 427.578 \\
    OpSysConsolidadoWindows 10 & -7.359 & 307.582 \\
    OpSysConsolidadoWindows 7 & 362.738 & 749.694 \\
    \bottomrule
    \end{tabular}
    \\[0.3cm]
    \small Las categorías de referencia son: TypeName = ``2 in 1 Convertible'', OpSysConsolidado = ``Chrome OS''
...
intervalos de confianza de las variables cuantitativas RAM y CPU no incluyen al 0, lo que indica que estas variables tienen un efecto consistente sobre la variable dependiente. En el caso de Pulgadas, el intervalo incluye el 0, lo que sugiere que su efecto no es estadísticamente significativo al 95\% de confianza. Respecto a las variables cualitativas, algunas categorías como Gaming, Linux y No OS tienen intervalos que incluyen el 0, indicando que no son indicativos consistentes del precio de una laptop. 
...
Estadístico DW & 2.0338 \\
p-valor & 0.547 \\
\bottomrule
\end{tabular}
\end{table}

Interpretación: Como el p-valor (0.547) es mayor que 0.05, no se rechaza H0. Los residuos son independientes. El valor del estadístico Durbin-Watson (2.0338) está cercano a 2, lo que confirma la ausencia de autocorrelación.
...
CPU (GHz) & 1.36 & Aceptable & Sin multicolinealidad \\
Pulgadas & 2.23 & Aceptable & Sin multicolinealidad \\
TypeName (conjunto) & 3.63 & Aceptable & Sin multicolinealidad \\
OpSysConsolidado (conjunto) & 1.49 & Aceptable & Sin multicolinealidad \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{enumerate}[leftmargin=1.5cm]
    \item El modelo de regresión lineal múltiple desarrollado explica aproximadamente el 70.5\% de la variabilidad en el precio de las laptops (R² = 0.705), lo que indica un buen ajuste del modelo.
    
    \item La frecuencia del CPU es el factor cuantitativo más influyente en el precio de una laptop. Por cada aumento de 1 GHz en la frecuencia del procesador, el precio aumenta en promedio 212.52 EUR. La memoria RAM también es importante: por cada GB adicional, el precio aumenta 81.10 EUR.
    
    \item El tamaño de pantalla muestra un efecto negativo en el precio (-20.17 EUR por pulgada), lo que sugiere que las laptops más caras tienden a ser más compactas pero con especificaciones superiores en otros aspectos.
    
    \item Las categorías de tipo de laptop y sistema operativo muestran diferencias significativas en el precio, siendo las Workstation las de mayor precio promedio (649.46 EUR más que las ``2 in 1 Convertible'').
    
    \item El supuesto de independencia se cumple (Durbin-Watson = 2.0338, p = 0.547) y no hay multicolinealidad (VIF \textless{} 5).
...
lm(formula = Price_euros ~ Ram_GB + CPU_GHz + Inches + TypeName + 
    OpSys_Consolidado, data = datos)

Residuals:
    Min      1Q  Median      3Q     Max 
-1898.50 -218.95  -48.19  161.42  2879.00 

Coefficients:
                       Estimate Std. Error t value Pr(>|t|)    
(Intercept)            256.224    159.955   1.602 0.109430    
Ram_GB                  81.097      2.581  31.418  < 2e-16 ***
CPU_GHz                212.524     24.319   8.739  < 2e-16 ***
Inches                 -20.165     11.075  -1.821 0.068882 .  
TypeNameGaming         -48.918     53.601  -0.913 0.361606    
TypeNameNetbook       -233.976     88.046  -2.657 0.007971 ** 
TypeNameNotebook      -289.965     42.820  -6.772 1.93e-11 ***
TypeNameUltrabook      133.461     45.441   2.937 0.003373 ** 
TypeNameWorkstation    649.459     85.047   7.636 4.33e-14 ***
OpSys_ConsolidadoLinux  -39.843     94.076  -0.424 0.671988    
OpSys_ConsolidadoNo OS -91.840     93.216  -0.985 0.324691    
OpSys_ConsolidadoOtros 220.355    105.629   2.086 0.037164 *  
OpSys_ConsolidadoWindows 10
                       150.111     80.268   1.870 0.061687 .  
OpSys_ConsolidadoWindows 7
                       556.216     98.622   5.640 2.09e-08 ***
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1

Residual standard error: 381.4 on 1289 degrees of freedom
Multiple R-squared:  0.7052,    Adjusted R-squared:  0.7022 
F-statistic: 237.2 on 13 and 1289 DF,  p-value: < 2.2e-16
\end{verbatim}
...
Prueba de Shapiro-Wilk:
  W = 0.92465, p-value < 2.2e-16
  Resultado: NO NORMAL

Prueba de Jarque-Bera:
  X-squared = 2349.7, df = 2, p-value < 2.2e-16
  Resultado: NO NORMAL

Prueba de Durbin-Watson:
  DW = 2.0338, p-value = 0.547
  Resultado: INDEPENDIENTES

Prueba de Breusch-Pagan:
  BP = 201.16, df = 13, p-value < 2.2e-16
